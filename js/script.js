...
function compareCounts(param){
    ...
    (compareDealer < comparePlayer && param === 'end-game') || (playerValue >= 22 && param === 'over-22') ? ($showWin.text('Oh no! You lost!'), updateBetAndRound('no-hide')) : '';
